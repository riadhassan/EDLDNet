...
def trainer_synapse(args, model, snapshot_path):
    ...
    if args.dataset.lower() == "synapse":
        ...
        print("Data Loader created of Synapse")
    elif args.dataset == "ACDC":
        db_train = ACDCdataset(args.root_path, args.list_dir, split="train", nclass=args.num_classes, transform=
                                transforms.Compose(
                                    [RandomGenerator(output_size=[args.img_size, args.img_size])]))
        print("Data Loader created of Synapse")
...
def inference_ACDC(args, model, best_performance):
...
def trainer_ACDC(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        performance = inference_ACDC(args, model, best_performance)
