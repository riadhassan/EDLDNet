...
parser.add_argument('--saved_model_path', type=str,
                    default='model_pth\\test\synapse\EDLDnet_synapse.pth', help='Give the saved weight file (pth) path of model')
...
if __name__ == "__main__":
    ...
    net = EDLDNet(num_classes=args.num_classes, kernel_sizes=args.kernel_sizes,
                         expansion_factor=args.expansion_factor, dw_parallel=not args.no_dw_parallel,
                         add=not args.concatenation, ag_ks=args.ag_ks, activation=args.activation_mscb,
    ...
    logging.basicConfig(filename=os.path.join(log_folder, "EDLDNet_synapse.txt"), level=logging.INFO,
